        ...
        <div class="container">
            <div class="card card-container" style="width:40%">
                ...
                <form method="post" accept-charset="utf-8" id="guardar_usuario2" name="guardar_usuario2" autocomplete="off" role="form" class="form-signin">
                    ...
                    <input type="text" class="form-control" id="NM_TELEFONO" name="NM_TELEFONO" placeholder="*Teléfono" title="Teléfono( sólo Números)" onkeypress="return numeros(event, this)" onblur="limpia(this)" id="miInput" class="form-control" minlength="7" maxlength="7"  required>

                    <label for="NM_CELULAR">*Celular:</label>
                    <input type="text" class="form-control" id="NM_CELULAR" name="NM_CELULAR" placeholder="*Celular" title="Celular( sólo Números)" onkeypress="return numeros(event, this)" class="form-control" minlength="10" maxlength="10"  required>
                    ...
                    <p>
                     ...
                     <p>
                        <label for="BANDA_ID">Tienes Banda, por favor selecciónela:</label>
                        <select name="BANDA_ID" id="BANDA_ID" title="" class="form-control" >
                        </select>
                    </p>

                    <p>
                        <label for="ES_LIDER">Es líder de la banda:</label>
