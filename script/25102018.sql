...
CREATE TABLE `rs_reserva_instrumentos` (
  ...
  CONSTRAINT `FK_INSTRUMENTOS` FOREIGN KEY (`ID_INSTRUMENTO`) REFERENCES `rs_instrumentos` (`ID_INSTRUMENTO`) ON UPDATE CASCADE,
  CONSTRAINT `FK_RESERVA_INSTRUMENTOS` FOREIGN KEY (`ID_RESERVA`) REFERENCES `rs_reserva_sala` (`id`) ON UPDATE CASCADE
...
-- ----------------------------
INSERT INTO `us_banda_usuario` VALUES ('1', 'Prueba C', 'Prueba c', 'activo');
INSERT INTO `us_banda_usuario` VALUES ('2', 'Pruebaaaaa', 'Prueba 1234', 'activo');
...
INSERT INTO `us_usuario` VALUES ('2147483647', '1', 'Diego', 'Mejia', '5555555', '5555555555', '555@gmail.com', null, '$2y$10$doEZ4hYMaAxgWZiPdyyIX.hMT3HQwLWT3xAIcuA3YCBeGzKGIcGRC', '3', '2', '2018-09-06 16:14:52', '0', '1', '0');
...
INSERT INTO `us_usuario` VALUES ('123123213123123', '1', 'carlos perez', 'calitos pppp', '2343243', '3423423423', 'edinson_wwwgallego23152@elpoli.edu.co', 'calle 12', '$2y$10$QE9pdz12/zkYApdm2rQg2.2.DxZ1olyWyQ2RVShUiYDnuIccnIQUq', '3', '2', '2018-10-16 12:55:50', '0', '0', '1');
...
INSERT INTO `us_usuario` VALUES ('452345243523452', '1', 'bueno', 'aja', '3243242', '2343243452', 'vuelta22222222@gmail.com', 'calle 2234', '$2y$10$.XREgbeKAACNeqgLXDjPC.t0CmV7rYpxNsS6SeIHndOYPoLOBN/Me', '3', '1', '2018-10-17 01:56:17', '0', '0', '1');
INSERT INTO `us_usuario` VALUES ('454385345849838', '2', 'asdfh', 'dfjsf', '3423333', '3333333333', 'oscar_mesa24092@elpoli.edu.co', 'calle falsa 1234', '$2y$10$sOLpMBBizGbLn/M9hLBlQeHv.uBdg1iKM64wjgWgGbIP/bOL27xAG', '3', '1', '2018-09-07 16:09:12', '0', '1', '1');
