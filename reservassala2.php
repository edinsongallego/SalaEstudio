...
<script>
		...
		$('#CalendarioWeb').fullCalendar({
			...
			hiddenDays: [0],
			events:'http://localhost/SalaEstudio/reservasala2.php',
      ...
      <div class="modal-body">
		...
		<div class="row">
		    ...
		    <div class="form-group col-md-4">
		      	...
		      	<input type="text" id="txtsala" class="form-control" value="Sala 2 | hora: 26000" disabled="disabled"><br/>
		    </div>  		
	    </div>
		<div class="row">
      		<div class="form-group col-md-4">
...
function EnviarInformacion(accion, objEvento, modal){
	$.ajax({
		type:'POST',
		url:'reservasala2.php?accion='+accion,
		dataType: "JSON",
		data:objEvento,
