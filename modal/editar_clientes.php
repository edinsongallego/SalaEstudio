		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_nombre" name="mod_nombre" placeholder="*Nombres" title="Nombre de usuario ( sólo letras )" onkeypress="return soloLetras(event)" onblur="limpia()" id="miInput" class="form-control"  required>
			   ...
			   <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_telefono" name="mod_telefono"placeholder="*Celular" title="Celular( sólo numeros)" onkeypress="return numeros(event)" onblur="limpia()" id="miInput" class="form-control" minlength="10" maxlength="10"  required>
				</div>
			  </div>
