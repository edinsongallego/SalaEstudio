...
if (empty($_POST['nombrebanda'])) {
    ...
    $errors[] = "Falta adicionar el lider de la banda.";
} elseif (empty($_POST['integrantes'])) {
    $errors[] = "Falta los integrantes de la banda.";
} elseif (
        !empty($_POST['nombrebanda']) && !empty($_POST['descripcionbanda'])) {
    ...
    $SQL = "DELETE FROM us_banda_detalle_usuario WHERE CS_BANDA_ID = $id_banda";
    $query_update = mysqli_query($con, $SQL);
