...
$sWhere .= " GROUP BY tp_producto.CS_PRODUCTO_ID,DATE_FORMAT(ft_factura.DT_FECHA_CREACION, '%Y-%m') ORDER BY ft_factura.DT_FECHA_CREACION DESC";
...
if (!isset($_REQUEST["reporte"])) {
    $count_query = mysqli_query($con, "SELECT
                                        ...
                                        DATE_FORMAT(ft_factura.DT_FECHA_CREACION, '%Y-%m') DT_FECHA
                                        FROM
                                        tp_producto
